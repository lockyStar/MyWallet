...
from finance.views import home,add_charge,account_status,random_example, add_account, send_total
...
urlpatterns = [
    ...
    url(r'^statistic/total/(?P<account_id>\d{1,16})/$', send_total, name='total_line'),
    ]
